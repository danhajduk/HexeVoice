...
flash_size_kconfig_symbol() {
  case "$1" in
    8MiB|8MB|8M) echo "CONFIG_ESPTOOLPY_FLASHSIZE_8MB" ;;
    16MiB|16MB|16M) echo "CONFIG_ESPTOOLPY_FLASHSIZE_16MB" ;;
    32MiB|32MB|32M) echo "CONFIG_ESPTOOLPY_FLASHSIZE_32MB" ;;
    *)
      echo "Unsupported board flash size: $1" >&2
      exit 1
      ;;
  esac
}

flash_size_kconfig_value() {
  case "$1" in
    8MiB|8MB|8M) echo "8MB" ;;
    16MiB|16MB|16M) echo "16MB" ;;
    32MiB|32MB|32M) echo "32MB" ;;
    *)
      echo "Unsupported board flash size: $1" >&2
      exit 1
      ;;
...
CONFIG_BT_NIMBLE_MSYS_1_BLOCK_SIZE=1024
