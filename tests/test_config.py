...
def test_assistant_settings_default_to_local_echo():
    ...
    assert settings.voice_timer_completed_mqtt_topic == "hexe/events/timer/completed"
    assert settings.voice_timer_completed_alarm_text == "Timer done."
...
def test_speaker_id_turn_policy_settings_default_to_safe_local_mode():
    ...
    assert settings.voice_speaker_id_preload is False
