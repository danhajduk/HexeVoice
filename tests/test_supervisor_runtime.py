...
def test_external_stt_service_status_action_and_supervisor_metadata(tmp_path):
    ...
    cuda_preflight = service.service_action(target="stt", action="cuda-preflight")
