...
| --- | --- | --- | --- | --- | --- | --- |
| `ha_voice_pe` | active | ESP32-S3 | 16 MiB / 8 MiB | none | XMOS XU316 input, TI AIC3204 output | `s3-16m-recovery-single-model-v1` |
| `esp_box_3` | unsupported | ESP32-S3 | 16 MiB / 16 MiB | 2.4 inch, 320 x 240 | ES7210 input, ES8311 output | `s3-16m-recovery-v1` |
| `waveshare_s3_touch_lcd_1_85c_box_v2` | active | ESP32-S3 | 16 MiB / 8 MiB | 1.85 inch round, 360 x 360, CST816S touch | ES7210 input, ES8311 output | `s3-16m-recovery-single-model-v1` |
...
build:
  idf_target: esp32s3
  partition_schema: s3-16m-recovery-single-model-v1
  app_slot_size: 4MiB
  recovery_app: true
hardware:
  soc: esp32s3
