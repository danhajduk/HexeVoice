...
- Firmware board wiring is profile-driven. `firmware/tools/generate_board_profile_config.py` emits `board_profile_pins.h`, `firmware/main/board/pins.h` includes that generated header, and buildable board adapters consume generated pin, bus, and device-address constants instead of keeping dev-board wiring inline.
