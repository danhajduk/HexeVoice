...
class Settings(BaseSettings):
    ...
    endpoint_discovery_udp_port: int = Field(default=9134, alias="ENDPOINT_DISCOVERY_UDP_PORT", ge=1, le=65535)
    endpoint_discovery_advertise_host: str | None = Field(default=None, alias="ENDPOINT_DISCOVERY_ADVERTISE_HOST")
    endpoint_discovery_use_tls: bool = Field(default=False, alias="ENDPOINT_DISCOVERY_USE_TLS")
    endpoint_beacon_udp_enabled: bool = Field(default=True, alias="ENDPOINT_BEACON_UDP_ENABLED")
    endpoint_beacon_udp_host: str = Field(default="255.255.255.255", alias="ENDPOINT_BEACON_UDP_HOST")
    endpoint_beacon_udp_port: int = Field(default=9135, alias="ENDPOINT_BEACON_UDP_PORT", ge=1, le=65535)
    endpoint_beacon_interval_seconds: float = Field(default=5.0, alias="ENDPOINT_BEACON_INTERVAL_SECONDS", gt=0)
    endpoint_beacon_advertise_host: str | None = Field(default=None, alias="ENDPOINT_BEACON_ADVERTISE_HOST")
    endpoint_mdns_enabled: bool = Field(default=True, alias="ENDPOINT_MDNS_ENABLED")
    endpoint_mdns_service_name: str = Field(default="HexeVoice", alias="ENDPOINT_MDNS_SERVICE_NAME")
    endpoint_mdns_service_type: str = Field(default="_hexevoice._tcp.local.", alias="ENDPOINT_MDNS_SERVICE_TYPE")
    endpoint_mdns_advertise_host: str | None = Field(default=None, alias="ENDPOINT_MDNS_ADVERTISE_HOST")
    ...
    def resolved_voice_speaker_id_model_cache_dir(self) -> Path:
        if self.voice_speaker_id_model_cache_dir is not None:
            return self.voice_speaker_id_model_cache_dir
        return self.runtime_dir / "speaker_id" / "models"
    ...
    def resolved_voice_placement_calibration_path(self) -> Path:
    ...
    def resolved_voice_admin_maintenance_path(self) -> Path:
