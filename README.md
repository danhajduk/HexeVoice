...
- Empty STT transcripts are handled locally as no-speech turns and are not sent to AI Node routing; audio-quality statuses such as low-level speech can also be promoted to no-speech per endpoint/device profile.
